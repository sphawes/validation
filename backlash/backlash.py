...
f.write("x_pos_pixel, y_pos_pixel, dir")
...
#commenting out scaling to try to remove weird rounding error
        ...
        if len(cnts) > 0:
            ...
            if radius > minRadius:
                ...
                posX = 100 - int((x / img_width)*100)
                posY = int((y / img_height)*100)
